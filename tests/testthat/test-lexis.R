...
test_that("test that import_lexis works with lexis Advance", {
    ...
    dat7 <- import_lexis('../data/lexis/guardian2.docx')
    ...
    dat8 <- import_lexis('../data/lexis/guardian3.docx')
    ...
    dat_all <- import_lexis('../data/lexis')
